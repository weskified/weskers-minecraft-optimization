...
- `-XX:+UseCriticalJavaThreadPriority`: Makes java threads have higher thread priority, can help a lot with latency but may interfere with other programs in your computer, mostly okay unless you're running a very low-end computer.
